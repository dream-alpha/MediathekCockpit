...
from Components.config import config, ConfigSelection, ConfigSelectionNumber, ConfigYesNo, ConfigDirectory, ConfigSubsection, ConfigNothing, NoSave, ConfigNumber
...
class ConfigInit():
	...
	def __init__(self):
		...
		config.plugins.mediathekcockpit.skip_audiodeskription = ConfigYesNo(default=True)
		config.plugins.mediathekcockpit.skip_trailer = ConfigYesNo(default=True)
		config.plugins.mediathekcockpit.skip_gebaerdensprache = ConfigYesNo(default=True)
		config.plugins.mediathekcockpit.skip_short_duration = ConfigSelectionNumber(0, 60, 1, default=5)
