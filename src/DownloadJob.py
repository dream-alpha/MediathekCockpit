...
class DownloadJob(Job):
	...
	def __init__(self, url, segments, target_path, event_name, short_description, description, rec_time, service_ref):
		logger.info("target_path: %s, event_name: %s, short_description: %s", target_path, event_name, short_description)
		logger.debug("segments: %s", segments)
		Job.__init__(self, "Download: " + event_name)
		self.target_path = target_path
		self.keep = True
		if segments:
			DownloadTaskHLS(self, url, segments, target_path, event_name, short_description, description, rec_time, service_ref)
		else:
			DownloadTaskFile(self, url, target_path, event_name, short_description, description, rec_time, service_ref)
